...
const howMuchPencil = (str) => {
  ...
  // console.log('strSplit is ', strSplit);
  let strJoin = strSplit.join('');
  // console.log('strJoin is ', strJoin);
  strSplit.forEach((value, index) => {
    // console.log('looping strJoin is ', strJoin);
    strSplit.slice(index, value);
    preResult.push(value);
  });
  // console.log('preResult is ', preResult);
  return result;
};
...
const wordsToCharList = (arr) => {
  // Solution code here...
  return arr.split('');
  // console.log('arr.split is ', arr.split(''));
};
...
const listFoods = (recipe) => {
  ...
  let stringifiedArray = JSON.stringify(gruffaloCrumble);
  // console.log(stringifiedArray);
  // gruffaloCrumble.ingredients.forEach((i) => {
  //   console.log(gruffaloCrumble.ingredients[i]);
  // });
  // console.log('with .join() it becomes ', gruffaloCrumble.ingredients.join(' '));
